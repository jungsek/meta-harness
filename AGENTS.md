...
- Project state: GitHub Issues + label state machine (ruled 2026-08-11) — the work-order store; org Projects v2 board is the human kanban view, never authoritative. Linear rejected: `06-REFERENCE/project-state-linear-vs-github.md`. Engine v0 (label-driven `run.sh`) designed but NOT built — refining first: `06-REFERENCE/engine-synthesis.md`.
