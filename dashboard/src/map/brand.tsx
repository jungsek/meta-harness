 ...
 * read. Marks are the tools' real logo paths (Simple Icons geometry); hues
 * are the official brand colors. Target panels are additionally tinted via
 * the `--brand` custom property (see app.css .mh-frame-brand).
 */
...
export interface Brand {
  ...
  label: string
  /** Brand hue — frame title, icon, panel tint. */
  color: string
  icon: (size?: number) => React.ReactNode
}

/** Anthropic's Claude starburst — the real mark, in Claude clay. */
...
/** OpenAI's blossom knot — the real mark, in the ChatGPT green. */
